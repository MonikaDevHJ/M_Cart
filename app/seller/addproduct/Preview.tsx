...
const Preview = () => {
  ...
  return (
    <div className="space-y-10">
      {/* HEADER */}
      <div>
        <h2 className="text-3xl font-bold text-gray-800">Review & Submit</h2>
      ...
      <div className=" ">
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-100 rounded-3xl p-8 shadow-sm">
          ...
          <div className="">
            <div className="flex gap-80     text-gray-700">
              <div className="space-y-10">
                <div className="flex gap-2">
                  <p className="text-sm text-gray-500 mt-1">Full Name:</p>
                  <p className="font-semibold text-lg">{state.client.name}</p>
                </div>

                <div className="flex gap-2">
                  <p className="text-sm text-gray-500 mt-1">Email:</p>
                  <p className="font-semibold text-lg">{state.client.email}</p>
                </div>

                <div className="flex gap-2">
                  <p className="text-sm text-gray-500 mt-1">Phone:</p>
                  <p className="font-semibold text-lg">{state.client.phone}</p>
                </div>
              </div>
              ...
              <div className="space-y-10">
                ...
                <div className="flex gap-2">
                  <p className="text-sm text-gray-500 mt-1">GST Number:</p>
                  <p className="font-semibold text-lg">
            ...
            <div>
              <p className="text-sm mt-10 text-gray-500">Description</p>
